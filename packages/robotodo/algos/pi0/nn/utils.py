# TODO ref taken from https://github.com/Physical-Intelligence/openpi/blob/03893832f2002a31016586874658662c669081ac/src/openpi/shared/nnx_utils.py
...
def nnx_frozen_jit(meth: Callable[P, R], *jit_args, **jit_kwargs) -> Callable[P, R]:
