...
KVCache: TypeAlias = tuple[jt.Float[jt.Array, "l b _t _k _h"], jt.Float[jt.Array, "l b _t _v _h"]]
...
class Module(nn.Module):
    ...
    # @jt.typecheck
    def embed(self, tokens: jt.Int[jt.Array, "b t"]) -> jt.Float[jt.Array, "b t d"]:
    ...
    def __call__(
        ...
        embedded: Sequence[jt.Float[jt.Array, "b _t _d"] | None],
        positions: jt.Int[jt.Array, "b t"],
        mask: jt.Bool[jt.Array, "b t s"],
        adarms_cond: Sequence[jt.Float[jt.Array, "b _d"] | None] | None = None,
        *,
        kv_cache: KVCache | None = None,
        deterministic: bool = True,
    ) -> tuple[Sequence[jt.Float[jt.Array, "b _t _d"] | None], KVCache]:
